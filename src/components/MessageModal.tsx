      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-2xl">
          ...
          <div className="flex justify-end space-x-3 py-4">
            <button
              onClick={onClose}
              className="rounded-lg bg-gray-300 px-5 py-2.5 text-sm font-medium text-gray-800 shadow-md transition-all hover:bg-gray-400 hover:cursor-pointer focus:outline-none focus:ring-4 focus:ring-gray-200"
            >
              Cancel
            </button>
            <button
